# Menstrual Cycle Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:menstrualcycle-api:1.1.13'
}
```
...
```java
import com.apiverve.menstrualcycle.MenstrualCycleCalculatorAPIClient;
import com.apiverve.menstrualcycle.APIResponse;
import com.apiverve.menstrualcycle.APIException;

// Initialize the client
MenstrualCycleCalculatorAPIClient client = new MenstrualCycleCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/menstrualcycle](https://docs.apiverve.com/ref/menstrualcycle)
...
- **Documentation:** [https://docs.apiverve.com/ref/menstrualcycle](https://docs.apiverve.com/ref/menstrualcycle)
- **Issues:** [GitHub Issues](https://github.com/apiverve/menstrualcycle-api/issues)
