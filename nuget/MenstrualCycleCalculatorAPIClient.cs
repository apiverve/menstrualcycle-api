...
namespace APIVerve.API.MenstrualCycleCalculator
{
    ...
    /// <summary>
    /// Client for the MenstrualCycleCalculator API
    /// </summary>
    public class MenstrualCycleCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/menstrualcycle";
        ...
        {
            { "last_period", new ValidationRule { Type = "string", Required = true, Format = "date" } },
            { "cycle_length", new ValidationRule { Type = "integer", Required = false, Min = 21, Max = 35 } },
            { "period_length", new ValidationRule { Type = "integer", Required = false, Min = 2, Max = 10 } },
            { "cycles", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 12 } }
        };
        ...
        public MenstrualCycleCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MenstrualCycleCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MenstrualCycleCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MenstrualCycleCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MenstrualCycleCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(MenstrualCycleCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MenstrualCycleCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MenstrualCycleCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MenstrualCycleCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MenstrualCycleCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MenstrualCycleCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MenstrualCycleCalculatorQueryOptions options)
        {
