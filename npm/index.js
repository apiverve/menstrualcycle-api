...
class menstrualcycleWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/menstrualcycle');
        }
        ...
        this.validationRules = {"last_period":{"type":"string","required":true,"format":"date"},"cycle_length":{"type":"integer","required":false,"min":21,"max":35,"default":28},"period_length":{"type":"integer","required":false,"min":2,"max":10,"default":5},"cycles":{"type":"integer","required":false,"min":1,"max":12,"default":3}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/menstrualcycle`);
        }
    }
...
module.exports = menstrualcycleWrapper;
