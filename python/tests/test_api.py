...
class TestMenstrualcycleAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MenstrualcycleAPIClient(self.api_key)

    @patch('apiverve_menstrualcyclecalculator.apiClient.requests.get')
