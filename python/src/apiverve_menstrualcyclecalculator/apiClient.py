...
class MenstrualcycleAPIClient:
    ...
    VALIDATION_RULES = {
        ...
        "cycle_length": {"type": "integer", "required": False, "min": 21, "max": 35, "default": 28},
        "period_length": {"type": "integer", "required": False, "min": 2, "max": 10, "default": 5},
        "cycles": {"type": "integer", "required": False, "min": 1, "max": 12, "default": 3}
    }
