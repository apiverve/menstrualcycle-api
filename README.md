...
```bash
curl -X GET "https://api.apiverve.com/v1/menstrualcycle?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/menstrualcycle](https://docs.apiverve.com/ref/menstrualcycle)

---

## Use Cases

Common use cases for the Menstrual Cycle Calculator API:
