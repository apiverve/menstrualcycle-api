...
{
    class MenstrualCycleCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/menstrualcycle";

        /// <summary>
        /// Make a GET request to the Menstrual Cycle Calculator API
        /// </summary>
        static async Task<JsonDocument> CallMenstrualCycleCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;last_period&quot;] &#x3D; &quot;2024-01-01&quot;, [&quot;cycle_length&quot;] &#x3D; 28, [&quot;period_length&quot;] &#x3D; 5, [&quot;cycles&quot;] &#x3D; 3 };
        ...
        {
            Console.WriteLine("📤 Calling Menstrual Cycle Calculator API...\n");

            var result = await CallMenstrualCycleCalculatorAPI();
